...
namespace evitoriav2.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly evitoriav2DbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = evitoriav2Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(evitoriav2DbContext context)
        {
            _context = context;
        }
