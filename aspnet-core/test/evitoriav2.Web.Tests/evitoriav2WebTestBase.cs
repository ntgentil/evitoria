...
{
    public abstract class evitoriav2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static evitoriav2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(evitoriav2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<evitoriav2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<evitoriav2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<evitoriav2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<evitoriav2DbContext, Task<T>> func)
        {
            T result;
